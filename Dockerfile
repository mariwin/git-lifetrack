...
FROM ubuntu:bionic
MAINTAINER mtobias <mariwin.tobias@gmail.com>
...
RUN \
    ...
    && a2enmod headers php${PHP_VERSION} \
    # Install composer
...
COPY ./conf/hosts.conf ${APACHE_CONF_DIR}/sites-enabled/hosts.conf
COPY ./conf/php.ini ${PHP_CONF_DIR}/apache2/conf.d/custom.installing
